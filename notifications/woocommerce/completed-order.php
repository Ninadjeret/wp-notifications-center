 ...
 * 
 */
class VOYNOTIF_notification_type_wc_completed_order extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_completed_order';
        $this->label = __( 'Completed order', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
     ...
     */
    function init() {
        add_action( 'woocommerce_order_status_completed_notification', array( $this, 'send' ), 1000, 3 );
    }
...
new VOYNOTIF_notification_type_wc_completed_order();
