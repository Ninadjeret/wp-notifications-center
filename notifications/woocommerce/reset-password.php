 ...
 * 
 */
class VOYNOTIF_notification_type_wc_reset_password extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_reset_password';
        $this->label = __( 'Reset password', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
     ...
     */
    function init() {
		add_action( 'woocommerce_reset_password_notification', array( $this, 'send' ), 1000, 3 );
    }
...
new VOYNOTIF_notification_type_wc_reset_password();
