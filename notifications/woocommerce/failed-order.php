 ...
 * 
 */
class VOYNOTIF_notification_type_wc_failed_order extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_failed_order';
        $this->label = __( 'Failed order', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
     ...
     */
    function init() {
        add_action( 'woocommerce_order_status_pending_to_failed_notification', array( $this, 'send' ), 1000, 3 );
        add_action( 'woocommerce_order_status_on-hold_to_failed_notification', array( $this, 'send' ), 1000, 3 );
    }
...
new VOYNOTIF_notification_type_wc_failed_order();
