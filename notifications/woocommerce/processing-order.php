 ...
 * 
 */
class VOYNOTIF_notification_type_wc_processing_order extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_processing_order';
        $this->label = __( 'Processing order', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
    ...
    function init() {
		...
		add_action( 'woocommerce_order_status_on-hold_to_processing_notification', array( $this, 'send' ), 1000, 3 );
...
new VOYNOTIF_notification_type_wc_processing_order();
