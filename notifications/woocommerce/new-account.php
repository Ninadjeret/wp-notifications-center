 ...
 * 
 */
class VOYNOTIF_notification_type_wc_new_account extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_new_account';
        $this->label = __( 'New account', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
...
new VOYNOTIF_notification_type_wc_new_account();
