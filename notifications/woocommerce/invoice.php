 ...
 * 
 */
class VOYNOTIF_notification_type_wc_invoice extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_invoice';
        $this->label = __( 'Invoice', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
...
new VOYNOTIF_notification_type_wc_invoice();
