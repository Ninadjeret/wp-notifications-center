 ...
 * 
 */
class VOYNOTIF_notification_type_wc_note extends VOYNOTIF_notification_type {
    ...
    function __construct() {
        ...
        $this->name = 'wc_note';
        $this->label = __( 'Note', 'notifications-center' );
        $this->tags = array(
            'woocommerce'
        );
     ...
     */
    function init() {
        add_action( 'woocommerce_new_customer_note_notification', array( $this, 'send' ), 1000, 3 );
    }
...
new VOYNOTIF_notification_type_wc_note();
